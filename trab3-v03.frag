...
Esfera inicializaEsfera (Esfera esfera, int texture){
	...
	//pinta(esfera.o.normalIn,esfera.o.cor,pIn);
...
Objeto uniao(Objeto obj_1, Objeto obj_2, bool final) {
    ...
    if (final) {
					pinta(objNovo.normalIn,objNovo.cor,getP(objNovo.entra));
    }
...
void desenho1(){
	...
	Objeto objeto1=uniao(cubo1.o,esfera1.o,false);
	
	Objeto objeto2=intersecao(esfera2.o,cubo2.o,false);

	objeto2=uniao(objeto1,objeto2,false);

	Objeto objetoFinal=intersecao(objeto2,limite.o,true);
}
void main(void){
	desenho1();
}
